...
def check_amp(model):
    ...
    def amp_allclose(m, im):
        ...
        a = m([batch, alt], imgsz=imgsz, device=device, verbose=False)[0].boxes.data  # FP32 inference
    ...
    try:
        ...
        assert amp_allclose(YOLO("ultralytics/cfg/models/11/yolo11-adaptive-resize.yaml"), im)
